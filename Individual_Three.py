...
# Построение дерева файловой системы с правами доступа с изменёнными данными
root = TreeNode("main_folder", "rwxr-xr--")
root.add_child(TreeNode("text_file.txt", "rw-r--r--"))
root.add_child(TreeNode("sub_folder", "rwxr--r--"))
root.children[0].add_child(TreeNode("img_file.png", "rwxr-xr--"))
root.children[0].add_child(TreeNode("doc_file.doc", "rw-r--r--"))
root.children[1].add_child(TreeNode("video_file.mp4", "rwxr-xr--"))
root.children[1].add_child(TreeNode("nested_folder", "rwxr--r--"))
root.children[1].children[1].add_child(TreeNode("archive.zip", "rw-r--r--"))
root.children[1].children[1].add_child(TreeNode("script.sh", "rwxr-xr--"))
root.children[1].children[1].add_child(TreeNode("notes.txt", "rwxr-xr--"))
