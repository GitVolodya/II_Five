...
# Построение дерева с изменёнными данными
root = TreeNode("folderA")
root.add_child(TreeNode("folderB"))
root.add_child(TreeNode("folderC"))
root.children[0].add_child(TreeNode("document1"))
root.children[1].add_child(TreeNode("image2"))
root.children[1].add_child(TreeNode("video3"))
...
print(path)  # Ожидаемый вывод: folderA -> folderC -> image2
