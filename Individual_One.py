...
left_child = BinaryTreeNode(6)
right_child = BinaryTreeNode(7)
root.add_children(left_child, right_child)
left_child.add_children(BinaryTreeNode(2), BinaryTreeNode(5))
right_child.add_children(BinaryTreeNode(8), BinaryTreeNode(9))
